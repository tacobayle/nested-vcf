...
do
  ...
  /bin/bash /home/ubuntu/nsx/set_object.sh "${ip_nsx_vip}" "${generic_password}" \
        ...
        "${json_data}"
#
# 9.1 error only for the non tenant object
#
# Creating NSX API session...
#HTTP PATCH API call to https://172.16.4.14/policy/api/v1/orgs/default/projects/project1/transit-gateways/default/attachments/gw-connection-1
#  Retrying HTTP PATCH API call to https://172.16.4.14/policy/api/v1/orgs/default/projects/project1/transit-gateways/default/attachments/gw-connection-1, http response code: 400, attempt: 0
#  Retrying HTTP PATCH API call to https://172.16.4.14/policy/api/v1/orgs/default/projects/project1/transit-gateways/default/attachments/gw-connection-1, http response code: 400, attempt: 1
#  Retrying HTTP PATCH API call to https://172.16.4.14/policy/api/v1/orgs/default/projects/project1/transit-gateways/default/attachments/gw-connection-1, http response code: 400, attempt: 2
#  FAILED HTTP PATCH API call to https://172.16.4.14/policy/api/v1/orgs/default/projects/project1/transit-gateways/default/attachments/gw-connection-1, response code was: 400
#{
#  "httpStatus" : "BAD_REQUEST",
#  "error_code" : 500242,
#  "module_name" : "Policy",
#  "error_message" : "Parent for the path=[/orgs/default/projects/project1/transit-gateways/default/attachments/gw-connection-1] does not exist. Please first create the parent with id default."
#}
done
log_message "#" "${log_file}" "" ""
#
